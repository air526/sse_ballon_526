...
public void run(){
	int bs=AudioRecord.getMinBufferSize(SAMPLE_RATE_IN_HZ,AudioFormat.CHANNEL_CONFIGURATION_MONO,
			AudioFormat.ENCODING_PCM_16BIT);
	recordInstance=new AudioRecord(MediaRecorder.AudioSource.MIC,SAMPLE_RATE_IN_HZ,2,2,bs);
